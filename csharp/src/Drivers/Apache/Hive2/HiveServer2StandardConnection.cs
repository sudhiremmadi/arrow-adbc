    ...
    internal class HiveServer2StandardConnection : HiveServer2ExtendedConnection
    {
        ...
        protected override TTransport CreateTransport()
        {
            ...
            if (TlsOptions.IsTlsEnabled)
            {
                ...
                {
                    baseTransport = new TTlsSocketTransport(ipAddress, portValue, config: thriftConfig, 0, null, certValidator);
                }
                else
                {
                    baseTransport = new TTlsSocketTransport(hostName!, portValue, config: thriftConfig, 0, null, certValidator);
                }
            }
            else
            {
