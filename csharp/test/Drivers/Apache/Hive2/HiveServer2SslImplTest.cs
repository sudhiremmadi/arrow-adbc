...
namespace Apache.Arrow.Adbc.Tests.Drivers.Apache.Hive2
{
    public class HiveServer2SslImplTest
    {
        ...
        public static IEnumerable<object?[]> GetSslOptionsTestData()
        {
            ...
            yield return new object?[] { new Dictionary<string, string> { { TlsOptions.IsSslEnabled, "false" } }, new TlsProperties { IsSslEnabled = false } };
            yield return new object?[] { new Dictionary<string, string> { { TlsOptions.IsSslEnabled, "True" } }, new TlsProperties { IsSslEnabled = true, AllowSelfSigned = false, AllowHostnameMismatch = false } };
            yield return new object?[] { new Dictionary<string, string> { { TlsOptions.IsSslEnabled, "tRUe" }, { TlsOptions.AllowSelfSigned, "true" } }, new TlsProperties { IsSslEnabled = true, AllowSelfSigned = true, AllowHostnameMismatch = false } };
            yield return new object?[] { new Dictionary<string, string> { { TlsOptions.IsSslEnabled, "TruE" }, { TlsOptions.AllowSelfSigned, "True" }, { TlsOptions.AllowHostnameMismatch, "True" } }, new TlsProperties { IsSslEnabled = true, AllowSelfSigned = true, AllowHostnameMismatch = true } };
            // certificate path is ignored if self signed is not allowed
            yield return new object?[] { new Dictionary<string, string> { { TlsOptions.IsSslEnabled, "True" }, { TlsOptions.AllowSelfSigned, "False" }, { TlsOptions.AllowHostnameMismatch, "True" }, { TlsOptions.TrustedCertificatePath, "" } }, new TlsProperties { IsSslEnabled = true, AllowSelfSigned = false, AllowHostnameMismatch = true } };
